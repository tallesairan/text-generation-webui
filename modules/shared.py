...
is_seq2seq = False
model_name = "None"
default_model_select = "TheBloke_Wizard-Vicuna-30B-Uncensored-GPTQ"
...
parser.add_argument('--api-streaming-port', type=int, default=5015, help='The listening port for the streaming API.')
